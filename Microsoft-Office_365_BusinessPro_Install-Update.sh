...
# Repo: https://github.com/aarondavidpolley/ScriptRepo/blob/master/Microsoft-Office_365_BusinessPro_Install-Update.sh
appURLmaster="https://go.microsoft.com/fwlink/?linkid=2009112"
...
appPKG="Microsoft_Office_BusinessPro_Installer-${appVers}.pkg"
